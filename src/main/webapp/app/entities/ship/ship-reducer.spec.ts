...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ship.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SHIP_LIST actions', async () => {
    ...
    it('dispatches FETCH_SHIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SHIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SHIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SHIP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SHIP actions', async () => {
      const expectedActions = [
        {
