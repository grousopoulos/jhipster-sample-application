...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './bunker-received-note.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BUNKERRECEIVEDNOTE_LIST actions', async () => {
    ...
    it('dispatches FETCH_BUNKERRECEIVEDNOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BUNKERRECEIVEDNOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BUNKERRECEIVEDNOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BUNKERRECEIVEDNOTE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BUNKERRECEIVEDNOTE actions', async () => {
      const expectedActions = [
        {
