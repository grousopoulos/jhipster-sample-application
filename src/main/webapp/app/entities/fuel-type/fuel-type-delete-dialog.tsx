...
import { getEntity, deleteEntity } from './fuel-type.reducer';
...
export const FuelTypeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.fuelType.delete.question">
        Are you sure you want to delete Fuel Type {fuelTypeEntity.id}?
      </ModalBody>
      <ModalFooter>
