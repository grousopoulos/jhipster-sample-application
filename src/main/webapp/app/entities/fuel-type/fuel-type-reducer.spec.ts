...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './fuel-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FUELTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_FUELTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FUELTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FUELTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FUELTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FUELTYPE actions', async () => {
      const expectedActions = [
        {
