...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EVENTREPORT_LIST actions', async () => {
    ...
    it('dispatches FETCH_EVENTREPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EVENTREPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EVENTREPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EVENTREPORT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EVENTREPORT actions', async () => {
      const expectedActions = [
        {
