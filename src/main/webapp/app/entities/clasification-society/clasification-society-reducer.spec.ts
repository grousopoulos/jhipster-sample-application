...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './clasification-society.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLASIFICATIONSOCIETY_LIST actions', async () => {
    ...
    it('dispatches FETCH_CLASIFICATIONSOCIETY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CLASIFICATIONSOCIETY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CLASIFICATIONSOCIETY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CLASIFICATIONSOCIETY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CLASIFICATIONSOCIETY actions', async () => {
      const expectedActions = [
        {
