...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './flag.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FLAG_LIST actions', async () => {
    ...
    it('dispatches FETCH_FLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FLAG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FLAG actions', async () => {
      const expectedActions = [
        {
