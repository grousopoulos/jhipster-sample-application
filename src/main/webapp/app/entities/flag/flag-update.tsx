...
import { getEntity, updateEntity, createEntity, reset } from './flag.reducer';
...
export const FlagUpdate = () => {
  ...
  const updating = useAppSelector(state => state.flag.updating);
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jhipsterSampleApplicationApp.flag.home.createOrEditLabel" data-cy="FlagCreateUpdateHeading">
