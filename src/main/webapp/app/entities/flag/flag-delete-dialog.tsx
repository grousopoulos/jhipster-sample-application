...
import { getEntity, deleteEntity } from './flag.reducer';
...
export const FlagDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleApplicationApp.flag.delete.question">Are you sure you want to delete Flag {flagEntity.id}?</ModalBody>
      <ModalFooter>
