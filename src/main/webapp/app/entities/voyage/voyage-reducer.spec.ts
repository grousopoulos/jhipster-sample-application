...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './voyage.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VOYAGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_VOYAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VOYAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VOYAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VOYAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VOYAGE actions', async () => {
      const expectedActions = [
        {
