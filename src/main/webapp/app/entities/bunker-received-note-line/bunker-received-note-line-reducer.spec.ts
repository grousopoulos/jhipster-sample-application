...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './bunker-received-note-line.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BUNKERRECEIVEDNOTELINE_LIST actions', async () => {
    ...
    it('dispatches FETCH_BUNKERRECEIVEDNOTELINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BUNKERRECEIVEDNOTELINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BUNKERRECEIVEDNOTELINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BUNKERRECEIVEDNOTELINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BUNKERRECEIVEDNOTELINE actions', async () => {
      const expectedActions = [
        {
