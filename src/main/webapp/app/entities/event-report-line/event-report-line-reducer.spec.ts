...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './event-report-line.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EVENTREPORTLINE_LIST actions', async () => {
    ...
    it('dispatches FETCH_EVENTREPORTLINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EVENTREPORTLINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EVENTREPORTLINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EVENTREPORTLINE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EVENTREPORTLINE actions', async () => {
      const expectedActions = [
        {
